...
- Zum Starten des Projektes wechseln Sie im Terminal (Terminal Ihres Rechners oder das Terminal in der IDE) in den Projektordner (`cd IKT-PWA-02`) und führen dort 
...
- vor Caching
- mit `sw.js`
- `sw.js` wird in `app.js` registriert
- 
